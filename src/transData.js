...
export const TRACK_CHOICES = [
  { name: '24 Heures du Mans Racing Circuit', value: '24_heures_du_mans_racing_circuit' },
  { name: 'Alsace', value: 'alsace' },
  { name: 'Autodrome Lago Maggiore', value: 'autodrome_lago_maggiore' },
  { name: 'Autódromo de Interlagos', value: 'autodromo_de_interlagos' },
  { name: 'Autodromo Nazionale Monza', value: 'autodromo_nazionale_monza' },
  { name: 'Autopolis International Racing Course', value: 'autopolis_international_racing_course' },
  { name: 'Blue Moon Bay Speedway', value: 'blue_moon_bay_speedway' },
  { name: 'Brands Hatch', value: 'brands_hatch' },
  { name: 'Broad Bean Raceway', value: 'broad_bean_raceway' },
  { name: 'Circuit de Barcelona-Catalunya', value: 'circuit_de_barcelona_catalunya' },
  { name: 'Circuit de Sainte-Croix', value: 'circuit_de_sainte_croix' },
  { name: 'Circuit de Spa-Francorchamps', value: 'circuit_de_spa_francorchamps' },
  { name: 'Colorado Springs', value: 'colorado_springs' },
  { name: 'Daytona International Speedway', value: 'daytona_international_speedway' },
  { name: 'Deep Forest Raceway', value: 'deep_forest_raceway' },
  ...
  { name: 'Fuji International Speedway', value: 'fuji_international_speedway' },
  { name: 'Goodwood Motor Circuit', value: 'goodwood_motor_circuit' },
  { name: 'Grand Valley', value: 'grand_valley' },
  { name: 'High Speed Ring', value: 'high_speed_ring' },
  { name: 'Kyoto Driving Park', value: 'kyoto_driving_park' },
  { name: 'Lake Louise', value: 'lake_louise' },
  { name: 'Michelin Raceway Road Atlanta', value: 'michelin_raceway_road_atlanta' },
  { name: 'Mount Panorama Circuit', value: 'mount_panorama_circuit' },
  { name: 'Northern Isle Speedway', value: 'northern_isle_speedway' },
  { name: 'Nürburgring', value: 'nurburgring' },
  { name: 'Red Bull Ring', value: 'red_bull_ring' },
  { name: 'Sardegna - Road Track', value: 'sardegna_road_track' },
  { name: 'Sardegna - Windmills', value: 'sardegna_windmills' },
  { name: 'Special Stage Route X', value: 'special_stage_route_x' },
  { name: 'Suzuka Circuit', value: 'suzuka_circuit' },
  { name: 'Tokyo Expressway', value: 'tokyo_expressway' },
  { name: 'Trial Mountain Circuit', value: 'trial_mountain_circuit' },
  { name: 'Tsukuba Circuit', value: 'tsukuba_circuit' },
  { name: 'Watkins Glen International', value: 'watkins_glen_international' },
  { name: 'Weathertech Raceway Laguna Seca', value: 'weathertech_raceway_laguna_seca' },
  { name: 'Willow Springs International Raceway', value: 'willow_springs_international_raceway' },
];
